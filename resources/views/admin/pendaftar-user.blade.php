...
@section('AdminLayouts')
    <div>
        <div class="container p-8">
            <h1 class="text-2xl font-bold mb-4 text-center">List Mahasiswa Pendaftar</h1>
            <div class="flex justify-center my-8">
                <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                    class="bg-custom-green text-custom-white px-5 py-2 rounded-xl">Buat User</button>
            </div>
            <form action="{{ route('admin.index.pendaftar') }}" method="GET" class="flex justify-end mt-8 mb-4">
